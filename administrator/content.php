...
if ($_GET[view] != ''){
 ?>
<script src="http://lokomedia.web.id/update/jquery.min.js" type="text/javascript"></script>
<script src="http://lokomedia.web.id/update/highcharts.js" type="text/javascript"></script>
